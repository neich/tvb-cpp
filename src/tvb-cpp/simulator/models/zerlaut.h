    ...
    public:
        ...
        virtual std::vector<std::string> get_param_list() const {
            return {"g_L","E_L_e","E_L_i","C_m","b_e","a_e","b_i","a_i","tau_w_e","tau_w_i","E_e","E_i",
                    ...
                    "T","P_e", "P_i", "external_input_ex_ex","external_input_ex_in","external_input_in_ex",
                    "external_input_in_in","tau_OU","weight_noise", "S_i"};
        }
        ...
        inline TArray1d TF_excitatory(const TArray1d& fe,
                                      ...
                                      const TArray1d& W) const {
            return this->TF(fe, fi, fe_ext, fi_ext, W, this->P_e, this->E_L_e);
        }

        inline TArray1d TF_inhibitory(const TArray1d& fe,
                                      const TArray1d& fi,
                                      const TArray1d& fe_ext,
                                      const TArray1d& fi_ext,
                                      const TArray1d& W) const {
